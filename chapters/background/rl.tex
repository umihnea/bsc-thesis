...
The usefulness of action-value functions comes from the fact that they can be used in MDPs whose exact structure is unknown.
This is crucial for solving RL problems as MDPs are typically unknown.
In contrast, evaluating the value function in state $s$ is conditional on knowing the probability distribution over all successor states $s'$.
